...
// const { GLTFLoader, ...rest } = THREE.example.jsm.loaders;
...
export default function () {
  ...
  return (
    <>
      <Canvas shadowMap sRGB={true} camera={{ position: [0, 5, 12], fov: 50 }} onClick={onClick}>
...
// function Paddle() {
//   // Load the gltf file
//   const { nodes, materials } = useLoader(GLTFLoader, "/jet.gltf")
