  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="_Chambre" rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <Clone
          object={Object.values(nodes).filter((n) => n.name.startsWith('Tapis_'))}
          receiveShadow
        />
        <Clone
          object={[nodes.Caisse_01_BLANC, nodes.Caisse_02_BLANC, nodes.Caisse_03_BLANC]}
          castShadow
          receiveShadow
        />
        <Clone
      ...
      <Clone
        object={[nodes._Boites, nodes._Livres, nodes._Post_it, nodes._Ventilations]}
        castShadow
      />
      <Lights />
    </group>
